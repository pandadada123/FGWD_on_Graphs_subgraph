...
'''G is Graph object
   g is nx_graph
'''
#%% 5 nodes different graphs
G11=Graph() # community 1
G11.add_attributes({0:0,1:1,2:2,3:1,4:4,5:5,6:4,7:5,8:1,9:1,10:4,11:4})    # add color to nodes
G11.add_edge((0,1))
G11.add_edge((1,4))
G11.add_edge((1,5))
G11.add_edge((4,5))
...
G12.add_attributes({0:0,1:1,2:4,3:5,4:1,5:4,6:4})
G12.add_edge((0,1))
G12.add_edge((1,2))
G12.add_edge((1,3))
G12.add_edge((2,3))

...
for N in NN:  
    ...
    for N3 in NN3:
        ...
        while num < Num:
            ...
            # The subgraph is fixed for each NN3
        ...
        if N == 5:
            ...
            DFGW_set2.append(DFGW)
            Percent12.append(yes1/Num)
            Percent22.append(yes2/Num)
        
            Mean2.append(np.mean(DFGW))
            STD2.append(np.std(DFGW))
            ...
            DFGW_set3.append(DFGW)
            Percent13.append(yes1/Num)
            Percent23.append(yes2/Num)
        
            Mean3.append(np.mean(DFGW))
            STD3.append(np.std(DFGW))
...
plt.plot(np.array(NN3), np.array(Mean), 'b-+',label='m = 5')
# plt.fill_between(np.array(NN3), np.array(Mean)-np.array(STD), np.array(Mean)+np.array(STD), alpha=0.5) # alpha here is transparency
plt.fill_between(np.array(NN3), np.array(Lower), np.array(Upper), facecolor = 'b',alpha=0.5) # alpha here is transparency
plt.plot(np.array(NN3), np.array(Mean2), 'k-+',label='m = 10')
# plt.fill_between(np.array(NN3), np.array(Mean)-np.array(STD), np.array(Mean)+np.array(STD), alpha=0.5) # alpha here is transparency
plt.fill_between(np.array(NN3), np.array(Lower2), np.array(Upper2), facecolor = 'k',alpha=0.5) # alpha here is transparency
plt.plot(np.array(NN3), np.array(Mean3), 'r-+',label='m = 15')
# plt.fill_between(np.array(NN3), np.array(Mean)-np.array(STD), np.array(Mean)+np.array(STD), alpha=0.5) # alpha here is transparency
plt.fill_between(np.array(NN3), np.array(Lower3), np.array(Upper3), facecolor = 'r', alpha=0.5) # alpha here is transparency

plt.grid()
plt.xlabel('Size of test graph (n)')
...
# %% plot percentage
plt.figure()
plt.plot(np.array(NN3), np.array(Percent1),'b-x', label='m = 5, exact match')
plt.plot(np.array(NN3), np.array(Percent2),'b--.', label='m = 5, approx match')
plt.plot(np.array(NN3), np.array(Percent12),'k-x', label='m = 10, exact match')
plt.plot(np.array(NN3), np.array(Percent22),'k--.', label='m = 10, approx match')
plt.plot(np.array(NN3), np.array(Percent13),'r-x', label='m = 15, exact match')
plt.plot(np.array(NN3), np.array(Percent23),'r--.', label='m = 15, approx match')
